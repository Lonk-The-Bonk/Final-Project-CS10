...
# Simulate landing on a Chance space
player1.position = find_space('Chance')
print(f"{player1.name} lands on {board[player1.position]}")
chance_deck = draw_card(chance_deck, player1)

# Simulate landing on a Community Chest space
player1.position = find_space('Community Chest')
print(f"{player1.name} lands on {board[player1.position]}")
community_chest_deck = draw_card(community_chest_deck, player1)
